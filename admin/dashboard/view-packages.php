...
$result = mysqli_query($dbConnect, "SELECT id,dest_ID,pkg_name,tour_duration,tour_price,pkg_thumbnail FROM packages ORDER BY id desc");
?>
    ...
    <table class="table table-bordered table-hover">
        ...
        <?php
            ...
            <tr>
                ...
                <?php echo "<td>".$row['dest_ID']."</td>"; ?>
                <?php echo "<td>".$row['pkg_name']."</td>"; ?>
                <?php echo "<td>".$row['tour_duration']."</td>"; ?>
                <?php echo "<td>".$row['tour_price']."</td>"; ?>                
                <td><a href="edit-destination.php?id=<?php echo $row['dest_id']; ?>&image=<?php echo $row['dest_image']; ?>">Edit</a></td>            
                <td><a href="delete-packages.php?id=<?php echo $row['id']; ?>&image=<?php echo $row['pkg_thumbnail']; ?>">Delete</a></td>
            </tr>
            <?php $count++; } ?>
        </tbody>
    </table>
